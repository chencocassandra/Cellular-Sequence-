...
const blocks = [
  ...
  },
  {
    ...
    body: "Grey-market injectables, research-only peptides as cart items, and anabolic oils or tablets. Those libraries stay educational. GLP-1 / NAD+ support patches in the shop are not those compounds.",
  },
];
