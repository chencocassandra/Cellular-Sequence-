...
export const COMPLETE_SEQUENCE: Record<string, string[]> = {
  ...
  "glp-1-support-patches": ["cellular-nad-protocol", "nad-plus-patches", "longevity-antioxidant"],
  "nad-plus-patches": ["cellular-nad-protocol", "longevity-antioxidant", "glp-1-support-patches"],
  "longevity-antioxidant": ["nad-plus-patches", "cellular-nad-protocol", "glp-1-support-patches"],
