...
export const COMPLETE_SEQUENCE: Record<string, string[]> = {
  ...
  "glp-1-support-patches": ["longevity-protocol", "nad-plus-patches", "nad-plus-tablets"],
  "nad-plus-patches": ["longevity-protocol", "nad-plus-tablets", "longevity-antioxidant"],
  "nad-plus-tablets": ["longevity-protocol", "nad-plus-patches", "longevity-antioxidant"],
  "longevity-antioxidant": ["nad-plus-tablets", "nad-plus-patches", "longevity-protocol"],
